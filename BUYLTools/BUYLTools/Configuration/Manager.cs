...
namespace BUYLTools.Configuration
{
    public class Manager
    {
        ...
        public Manager(Assembly _myAssembl)
        {
            OpenAssemblyConfiguration(_myAssembl);
        }

        public Manager(Assembly _myAssembl, bool open)
        {
            try
            {
        ...
        public Manager(string DirectConfigPath, Assembly assembly)
        {
